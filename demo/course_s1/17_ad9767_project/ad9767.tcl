...
# 添加coe文件
add_files -fileset sources_1  -copy_to $work_dir/$proj_name -force -quiet [glob -nocomplain $work_dir/*.coe]
#生成Block Design
...
set_property top_file "/$work_dir/$proj_name/$proj_name.srcs/sources_1/new/ad9767_test.v" [current_fileset]
#运行综合、实现和生成比特流
#synth_design -to_current_top
synth_design -top ad9767_test
opt_design
place_design
route_design
